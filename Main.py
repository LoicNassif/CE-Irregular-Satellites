...
def main():
    ...
    M_s = 1.989e30; M_pl = 1.0243e26; a_pl = 7.7792e11
    ...
    plt.title("Area of Circumplanetary Swarm - Neptune-mass Jupiter")
    plt.legend()
    plt.xlim([2e5, 1e10])
    plt.ylim([5e-10, 1e-5])
    plt.show()

    # jupiter4 = CollSwarm(7.37307e19, 100., 150000., 3.828e26, 1.989e30,
    #                     1.89587112e27, 7.7792e11, 6.9911e7, 0.4, 6.)
    #
    # drange = linspace(0.1, 1e5, 5000)
    ...
    #         num.append(jupiter4.computen(drange[i]))
